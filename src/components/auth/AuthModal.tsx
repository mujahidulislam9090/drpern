...
export function AuthModal({ isOpen, onClose, defaultMode = "login" }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-md rounded-2xl glass-card p-6 sm:p-8 shadow-2xl border border-slate-700/60">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        {error && (
          <div className="mb-4 p-3.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-medium leading-relaxed">
            {error}
          </div>
        )}
